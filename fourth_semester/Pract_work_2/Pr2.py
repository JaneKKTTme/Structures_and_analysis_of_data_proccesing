...
def middle_line(array, number):
    ml = (array[number] + array[number-1] + array[number-2] + array[number-3] + array[number-4])/5
    return ml        
